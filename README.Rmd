...
The `classify_network()` function uses a graph-theoretic approach to identify:

- **Loops**: Edges internal to complex intersections (start and end at the same node cluster)
- **Parallel**: Multiple edges connecting the same pair of node clusters (dual carriageways)
...
- **Merge** parallel groups into single centerlines using skeletonization
